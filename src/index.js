...
var _user$project$Refutation$dropDuplicates = function (list) {
	var step = F2(
		function (next, _p0) {
			var _p1 = _p0;
			var _p3 = _p1._0;
...
var _user$project$Refutation$select = function (xs) {
	var _p4 = xs;
	if (_p4.ctor === '[]') {
		return {ctor: '[]'};
	} else {
			...
			_1: A2(
				...
				function (_p5) {
					...
					return {
						ctor: '_Tuple2',
						_0: _p6._0,
						_1: {ctor: '::', _0: _p7, _1: _p6._1}
					};
				},
				_user$project$Refutation$select(_p8))
		};
	}
};
var _user$project$Refutation$permutations = function (xss) {
	var _p9 = xss;
	if (_p9.ctor === '[]') {
		return {
			ctor: '::',
		...
		var f = function (_p10) {
			...
			return A2(
				...
				_user$project$Refutation$permutations(_p11._1));
		};
		return A2(
			_elm_lang$core$List$concatMap,
			f,
			_user$project$Refutation$select(_p9));
	}
};
var _user$project$Refutation$removeFromList = F2(
	function (list, c) {
		var _p12 = list;
		if (_p12.ctor === '[]') {
			return {ctor: '[]'};
			...
			var _p14 = _p12._0;
			var _p13 = _p12._1;
			return _elm_lang$core$Native_Utils.eq(_p14, c) ? _p13 : {
				ctor: '::',
				_0: _p14,
				_1: A2(_user$project$Refutation$removeFromList, _p13, c)
			};
		}
	});
var _user$project$Refutation$removeFromString = F2(
	function (s, c) {
		return _elm_lang$core$String$fromList(
			A2(
				_user$project$Refutation$removeFromList,
...
var _user$project$Refutation$aligns = F2(
	function (ncs, oc) {
		var olist = A2(
			...
			_elm_lang$core$String$toList(oc));
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(olist),
			_elm_lang$core$List$length(ncs)) && A2(
			_elm_lang$core$List$all,
			_elm_lang$core$Basics$identity,
			A3(_elm_lang$core$List$map2, _elm_lang$core$String$contains, olist, ncs));
	});
var _user$project$Refutation$step = F2(
	function (ncs, oc) {
		var aligned_nands = _elm_lang$core$List$head(
			A2(
...
var _user$project$App$contains_clause = F2(
	function (s, list) {
		return A2(
			_elm_lang$core$List$any,
			function (c) {
				return _elm_lang$core$Native_Utils.eq(c.term, s);
			},
			list);
	});
...
var _user$project$App$Model = F4(
	function (a, b, c, d) {
		return {nands: a, ors: b, current: c, generated: d};
	});
var _user$project$App$Clause = F3(
	function (a, b, c) {
		return {term: a, ctype: b, status: c};
	});
var _user$project$App$NAND = {ctor: 'NAND'};
var _user$project$App$OR = {ctor: 'OR'};
var _user$project$App$Selectable = {ctor: 'Selectable'};
var _user$project$App$new_clause = F2(
	function (s, t) {
...
var _user$project$App$getSelectedNANDs = function (model) {
	return A2(
		_elm_lang$core$List$filter,
		function (n) {
			return _elm_lang$core$Native_Utils.eq(n.status, _user$project$App$Selected);
		},
		model.nands);
};
var _user$project$App$getSelectedOR = function (model) {
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$filter,
			function (o) {
				return _elm_lang$core$Native_Utils.eq(o.status, _user$project$App$Selected);
			},
			model.ors));
};
...
var _user$project$App$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('main_section'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$App$InputChanged),
							_1: {
								ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						A2(_user$project$App$display_result_components, model.nands, model.generated)),
					_1: {ctor: '[]'}
				}
			}
		});
